...
import { runTrainingSimulation } from './trainingRuntime';

const createPlayer = (attributeValue = 0.2) => ({
  id: 'p1',
  name: 'Test Player',
...
describe('notify training runtime', () => {
  ...
  it('keeps maxed attributes capped without producing fail', () => {
    const simulation = runTrainingSimulation(
      [createPlayer(1)],
      [training],
      createRng(0.2, 0.9),
