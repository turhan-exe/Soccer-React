...
export type MatchStatusResponse = {
  ...
  presentationRelinkPendingCount?: number | null;
  presentationAnimatorPendingCount?: number | null;
  presentationMaterialPendingCount?: number | null;
  presentationVisibilityPendingCount?: number | null;
  nameUiPendingCount?: number | null;
  nameUiSuppressed?: boolean | null;
  nameUiGateReason?: string | null;
  materialVisualState?: string | null;
  presentationQueueDepth?: number | null;
  presentationQueuePaused?: boolean | null;
  presentationQueuePauseReason?: string | null;
  activeAuxCameraCount?: number | null;
  whitelistedAuxCameraCount?: number | null;
  lastHeavyPhase?: string | null;
  lastHeavyPhaseDurationMs?: number | null;
  perfSnapshotPath?: string | null;
  perfSnapshotReason?: string | null;
  ballFocusState?: string | null;
